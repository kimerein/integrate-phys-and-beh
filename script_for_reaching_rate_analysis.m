...
trial1='trialTypes.touch_in_cued_window_1forward==0 & trialTypes.led_1forward==0 & trialTypes.optoGroup_1forward~=1 & trialTypes.optoGroup~=1  & trialTypes.isLongITI_1forward==1';
...
reachratesettings.addSessionLines=true; % for no averaging across sessions plot, whether to connect trial bins within same session with lines
