...
plotSaveOutShift(alltbt,trialTypes,metadata,cuedreachtimewindow,[-2.5 -0.25],[3],[0 optoDuration],'cued success','reachBatch_success_reachStarts',false,3,'success',sad,savePlotsDir,['win3_minus3to025_optoDurforcue' addtoall],tbt_filter);
% plotSaveOutShift(alltbt,trialTypes,metadata,cuedreachtimewindow,[-3 -0.25],[3],[0 optoDuration],'cued success nplus1led','reachBatch_success_reachStarts',false,3,'success',sad,savePlotsDir,['win3_minus3to025_optoDurforcue' addtoall],tbt_filter);
return
...
plotSaveOutShift(alltbt,trialTypes,metadata,cuedreachtimewindow,[-2.5 -0.25],[3],[0 optoDuration],'all cued failures','anyFail',false,3,'failed cued reach',sad,savePlotsDir,['win3_minus3to025_optoDurforcue' addtoall],tbt_filter);
...
plotSaveOutShift(alltbt,trialTypes,metadata,cuedreachtimewindow,[-3 -0.25],[3],[0 optoDuration],'all cued failures','reachBatch_drop_reachStarts',false,3,'failed cued reach',sad,savePlotsDir,['win3_minus3to025_optoDurforcue' addtoall],tbt_filter);


% Uncued drop
plotSaveOutShift(alltbt,trialTypes,metadata,cuedreachtimewindow,[-3 -0.25],[3],[3.5 7],'uncued failure','reachBatch_drop_reachStarts',false,3,'false alarm',sad,savePlotsDir,['win3_minus3to025' addtoall],tbt_filter);
...
% % plotSaveOutShift(alltbt,trialTypes,metadata,cuedreachtimewindow,[-3 -0.25],[3],[3.5 7],'delayed success nplus1led','reachBatch_success_reachStarts',false,3,'delayed success',sad,savePlotsDir,['win3_minus3to025' addtoall],tbt_filter);
...
% % plotSaveOutShift(alltbt,trialTypes,metadata,cuedreachtimewindow,[-3 -0.25],[3],[3.5 7],'uncued failure nplus1led','anyFail',false,3,'false alarm',sad,savePlotsDir,['win3_minus3to025' addtoall],tbt_filter);
return
...
[returnThis,returnThisRef]=plotBehaviorEventFx(dataset.realDistributions,alltbt,[],'plot_rt_pdf');
returnThisCDF=plotBehaviorEventFx(dataset.realDistributions,alltbt,[],'plot_rt_cdf'); 
