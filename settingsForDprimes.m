...
settings.preCueWindow_start2=cuetimeat+3; %8.5;  
settings.preCueWindow_end2=cuetimeat+4; %9.5; 
settings.reachAfterCueWindow_start=-0.25; % after cue window in seconds, for hits, i.e., real cued reaching
settings.reachAfterCueWindow_end=0.75; % after cue window in seconds, for hits, i.e., real cued reaching
