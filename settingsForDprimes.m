...
settings.preCueWindow_start1=cuetimeat-0.5; %+0.25; %-0.45; %0; % define start of time window from trial onset, in seconds -- for first window, assuming that trial onset is 0 sec
...
settings.preCueWindow_start2=cuetimeat+9; %0.75; %0.5; %0.5; %8.5;  
settings.preCueWindow_end2=cuetimeat+9.5; %1.25; %-0.25; %1; %0.95; %9.5; 
settings.reachAfterCueWindow_start=-0.035; %-0.05; %-0.25; % after cue window in seconds, for hits, i.e., real cued reaching
settings.reachAfterCueWindow_end=0.5-0.035; %0.4; %0.75; % after cue window in seconds, for hits, i.e., real cued reaching

% For testing whether mouse is reaching to distractor
settings.distract.preCueWindow_start1=cuetimeat-0.5; 
settings.distract.preCueWindow_end1=cuetimeat;
settings.distract.preCueWindow_start2=cuetimeat+9;
settings.distract.preCueWindow_end2=cuetimeat+9.5;
settings.distract.reachAfterCueWindow_start=-0.035;
settings.distract.reachAfterCueWindow_end=0.5-0.035;
