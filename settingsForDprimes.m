...
% settings.preCueWindow_end1=cuetimeat;
% settings.preCueWindow_start2=cuetimeat-0.98;
% settings.preCueWindow_end2=cuetimeat-0.98+0.4;
% settings.reachAfterCueWindow_start=-0.05;
% settings.reachAfterCueWindow_end=0.35;

% USING FOR EXTERNAL VIS CUE, JUST ONE PRE-CUE WINDOW
settings.preCueWindow_start1=cuetimeat-1.25; %+0.25; %-0.45; %0; % define start of time window from trial onset, in seconds -- for first window, assuming that trial onset is 0 sec
...
settings.preCueWindow_start2=cuetimeat-1.25; % if these are same time, will not use second window %0.75; %0.5; %0.5; %8.5;  
settings.preCueWindow_end2=cuetimeat-0.25; %1.25; %-0.25; %1; %0.95; %9.5; 
settings.reachAfterCueWindow_start=0; %-0.4; %-0.05; %-0.25; % after cue window in seconds, for hits, i.e., real cued reaching
settings.reachAfterCueWindow_end=0.6; %0.1; %1.33; %0.75; % after cue window in seconds, for hits, i.e., real cued reaching
...
% settings.preCueWindow_end1=cuetimeat-0.4; %1; % define end of time window from trial onset, in seconds -- for first window
% % preCueWindow_start2=3.81; % define start of time window from trial onset, in seconds -- for second window
% % preCueWindow_end2=5.31; % define end of time window from trial onset, in seconds -- for second window
% settings.preCueWindow_start2=cuetimeat-0.4; % if these are same time, will not use second window %0.75; %0.5; %0.5; %8.5;  
% settings.preCueWindow_end2=cuetimeat-0.4; %1.25; %-0.25; %1; %0.95; %9.5; 
% settings.reachAfterCueWindow_start=0; %-0.4; %-0.05; %-0.25; % after cue window in seconds, for hits, i.e., real cued reaching
% settings.reachAfterCueWindow_end=0.4; %0.1; %1.33; %0.75; % after cue window in seconds, for hits, i.e., real cued reaching
...
% SC: use comparison window right before reach
% settings.preCueWindow_start1=cuetimeat-0.4; %+0.25; %-0.45; %0; % define start of time window from trial onset, in seconds -- for first window, assuming that trial onset is 0 sec
% settings.preCueWindow_end1=cuetimeat; %1; % define end of time window from trial onset, in seconds -- for first window
% % preCueWindow_start2=3.81; % define start of time window from trial onset, in seconds -- for second window
% % preCueWindow_end2=5.31; % define end of time window from trial onset, in seconds -- for second window
