...
settings.preCueWindow_start1=cuetimeat-1.5; %cuetimeat-0.4; %+0.25; %-0.45; %0; % define start of time window from trial onset, in seconds -- for first window, assuming that trial onset is 0 sec
...
settings.preCueWindow_end2=cuetimeat-0.98+1.5; %0.4; %1.25; %-0.25; %1; %0.95; %9.5; 
settings.reachAfterCueWindow_start=-0.05; %-0.05; %-0.25; % after cue window in seconds, for hits, i.e., real cued reaching
settings.reachAfterCueWindow_end=-0.05+1.5; %0.35; %0.75; % after cue window in seconds, for hits, i.e., real cued reaching
