...
settings.useTheseTestSets={'cued_failureIntersectNOT'}; %{'cued_failureIntersect'}; %{'cued_failure','uncued_failure'};
settings.useTheseTestFilenames={'cuedFailure'}; %{'cuedFailure'}; %{'cuedFailure','uncuedFailure'};
