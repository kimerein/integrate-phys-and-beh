...
settings.preCueWindow_start1=cuetimeat-1.5; %+0.25; %-0.45; %0; % define start of time window from trial onset, in seconds -- for first window, assuming that trial onset is 0 sec
...
settings.preCueWindow_start2=cuetimeat+3; % if these are same time, will not use second window %0.75; %0.5; %0.5; %8.5;  
