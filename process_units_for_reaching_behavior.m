...
cuez=getCueTunedUnits(cue_noReach_Response,uncuedReach_Response,'cue_vs_baseline','mean'); % method 3rd arg can be 'vs_uncued_reach' or 'cue_vs_baseline' or 'justcue'
