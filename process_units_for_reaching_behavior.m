...
%     cued_success_Response.glm_boundary_2(y<=(-0.0212442/0.00951011).*x & x<0 & x>-0.015 & y>(0.0145055/0.0250066).*x)=2; % purple
    ...
    figure(); s=scatter(abs((0.5*cued_success_Response.allsucc_sus1to5sec(cued_success_Response.idx_from_glm==2 & confidence>0.5)+0.5*cued_success_Response.cXsucc_sus1to5sec(cued_success_Response.idx_from_glm==2 & confidence>0.5))-(0.5*cued_success_Response.allfail_sus1to5sec(cued_success_Response.idx_from_glm==2 & confidence>0.5)+0.5*cued_success_Response.cXfail_sus1to5sec(cued_success_Response.idx_from_glm==2 & confidence>0.5))),cued_success_Response.combosuccess_modulation_index(cued_success_Response.idx_from_glm==2 & confidence>0.5),100,cmap(2,:),'filled'); % purple
    s.MarkerFaceAlpha=0.4; s.MarkerEdgeAlpha=0.4; hold on;
    ...
    testWhereCyanPurpleDifference(abs((0.5*cued_success_Response.allsucc_sus1to5sec+0.5*cued_success_Response.cXsucc_sus1to5sec)-(0.5*cued_success_Response.allfail_sus1to5sec+0.5*cued_success_Response.cXfail_sus1to5sec)),cued_success_Response.combosuccess_modulation_index,templabel,cmap,[0.5 1.5]);
    ...
    s.MarkerFaceAlpha=0.8; s.MarkerEdgeAlpha=0.8;

%     figure(); s=scatter(abs((0.5*cued_success_Response.allsucc_sus1to5sec(cued_success_Response.idx==2)+0.5*cued_success_Response.cXsucc_sus1to5sec(cued_success_Response.idx==2))-(0.5*cued_success_Response.allfail_sus1to5sec(cued_success_Response.idx==2)+0.5*cued_success_Response.cXfail_sus1to5sec(cued_success_Response.idx==2))),cued_success_Response.combosuccess_modulation_index(cued_success_Response.idx==2),100,cmap(2,:),'filled'); % purple
%     s.MarkerFaceAlpha=0.4; s.MarkerEdgeAlpha=0.4; hold on;
%     s=scatter(abs((0.5*cued_success_Response.allsucc_sus1to5sec(cued_success_Response.idx==1)+0.5*cued_success_Response.cXsucc_sus1to5sec(cued_success_Response.idx==1))-(0.5*cued_success_Response.allfail_sus1to5sec(cued_success_Response.idx==1)+0.5*cued_success_Response.cXfail_sus1to5sec(cued_success_Response.idx==1))),cued_success_Response.combosuccess_modulation_index(cued_success_Response.idx==1),100,cmap(1,:),'filled'); % cyan
%     s.MarkerFaceAlpha=0.4; s.MarkerEdgeAlpha=0.4;
    figure(); s=scatter(abs((0.5*cued_success_Response.allsucc_sus1to5sec(cued_success_Response.idx==2 & cued_success_Response.isHighWeight==1)+0.5*cued_success_Response.cXsucc_sus1to5sec(cued_success_Response.idx==2 & cued_success_Response.isHighWeight==1))-(0.5*cued_success_Response.allfail_sus1to5sec(cued_success_Response.idx==2 & cued_success_Response.isHighWeight==1)+0.5*cued_success_Response.cXfail_sus1to5sec(cued_success_Response.idx==2 & cued_success_Response.isHighWeight==1))),cued_success_Response.combosuccess_modulation_index(cued_success_Response.idx==2 & cued_success_Response.isHighWeight==1),100,cmap(2,:),'filled'); % purple
    s.MarkerFaceAlpha=0.4; s.MarkerEdgeAlpha=0.4; hold on;
