...
% line for dividing up outlier group neurons, unity
...
idx_from_glm(idx_from_glm==2 & metrics.allFail_sustained>metrics.allSucc_sustained)=3; 
idx_from_glm(idx_from_glm==2 & metrics.allFail_sustained<=metrics.allSucc_sustained)=1;
...
load('Z:\MICROSCOPE\Kim\Physiology Final Data Sets\GLM\python glm training set\idx_from_glm.mat'); idx_from_glm=idx_from_glm(orderingSuccVFail);
