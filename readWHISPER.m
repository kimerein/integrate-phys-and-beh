function [data,Fs]=readWHISPER(binName, path, chList, firstNmins)
...
nSamp = floor((firstNmins*60) * SampRate(meta)); % firstNmins only
...
if dataType == 'A'
    ...
    data=nan(length(chList),length(dataArray(chList(1),:)));
