function plotPhysiologyResult(photometry_tbt,behavior_tbt,outdata,alignTo,plotPhotoField,plotBehField,firstInTrialOrLast,withinRange)
...
switch alignTo
    case 'cue'
        ...
        hold on;
        plotWStderr(nanmean(photometry_tbt.cue,1)*nanmax(nanmean(photometry_tbt.(plotPhotoField),1)),f_times,'b',f,size(photometry_tbt.cue,1));
