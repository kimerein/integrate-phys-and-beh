...
currentcombo=cueddiff(cued_success_Response.consensus_idx==2);
...
currentcombo=cueddiff(cued_success_Response.consensus_idx==1);
...
% uncued
currentcombo=uncueddiff(cued_success_Response.consensus_idx==2);
f=find(cued_success_Response.consensus_idx==2);
[~,si]=sort(currentcombo,'descend');
temp=uncuedsuccess_minus_uncuedfailure(f(si),:);
figure(); imagesc(temp); colormap('winter');
title('gp2 uncued success minus failure');
currentcombo=uncueddiff(cued_success_Response.consensus_idx==1);
f=find(cued_success_Response.consensus_idx==1);
[~,si]=sort(currentcombo,'descend');
temp=uncuedsuccess_minus_uncuedfailure(f(si),:);
figure(); imagesc(temp); colormap('winter');
...
% cued minus uncued
% success
currentcombo=successdiff(cued_success_Response.consensus_idx==2);
f=find(cued_success_Response.consensus_idx==2);
[~,si]=sort(currentcombo,'descend');
temp=cuedsuccess_minus_uncuedsuccess(f(si),:);
figure(); imagesc(temp); colormap('spring');
title('gp2 success cued minus uncued');
currentcombo=successdiff(cued_success_Response.consensus_idx==1);
f=find(cued_success_Response.consensus_idx==1);
[~,si]=sort(currentcombo,'descend');
temp=cuedsuccess_minus_uncuedsuccess(f(si),:);
figure(); imagesc(temp); colormap('spring');
...
% failure
currentcombo=failurediff(cued_success_Response.consensus_idx==2);
f=find(cued_success_Response.consensus_idx==2);
[~,si]=sort(currentcombo,'descend');
temp=cuedfailure_minus_uncuedfailure(f(si),:);
figure(); imagesc(temp); colormap('spring');
title('gp2 failure cued minus uncued');
currentcombo=failurediff(cued_success_Response.consensus_idx==1);
f=find(cued_success_Response.consensus_idx==1);
[~,si]=sort(currentcombo,'descend');
temp=cuedfailure_minus_uncuedfailure(f(si),:);
figure(); imagesc(temp); colormap('spring');
