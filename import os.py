...
def getBodyPartPosition(
    ...
    directory=r'Z:\MICROSCOPE\Kim\KER Behavior\By date\High speed\20190510\3F_white\DLC output\test'
...
def getPawPosData(directory,filename,bodyparts,p_cutoff,whichbodypart):
