...
rateFits=getRateFits(alltbt,dataset,reachType,useCuedRateData,withinRange,cueName,trialDuration);
...
rateFits=getRateFits(alltbt,wrtDataset,'miss',useCuedRateData,withinRange,cueName,trialDuration);
...
if n_trials_away~=1
    error('assumed only doing 1 trial away');
end
