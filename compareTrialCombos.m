...
if doPlot==1
    ...
    plotHist(RT_pairs1,RT_pairs2,forPairs_sequenceMatchStarts1,forPairs_sequenceMatchStarts2,50,'Compare Pairs','Change in RT');
...
if doPlot==1
    plotHist(temp1,temp2,temp_match1,temp_match2,200,'Compare Non-Paired RTs','RTs');
end
...
s=scatter(usePrev(RT_pairs1.real_rt_pair==true & testcond1==true),useCurr(RT_pairs1.real_rt_pair==true & testcond1==true),[],'k','filled');
pause;
...
s=scatter(usePrev(RT_pairs2.real_rt_pair==true & testcond2==true),useCurr(RT_pairs2.real_rt_pair==true & testcond2==true),[],'r','filled');
pause;
m=get(s,'MarkerHandle');
alpha=0.3;
