...
settings.preCueWindow_start1=cuetimeat-0.98-0.43; % define start of time window from trial onset, in seconds -- for first window, assuming that trial onset is 0 sec
...
settings.reachAfterCueWindow_end=-0.98+0.43;
